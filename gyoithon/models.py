...
class Organization(models.Model):
    ...
    overview = models.TextField(verbose_name='Overview', max_length=1000, default='N/A')
...
class Subdomain(models.Model):
    ...
    overview = models.TextField(verbose_name='Overview', max_length=1000, default='N/A')
    ip_address = models.TextField(verbose_name='IP Address', max_length=255, default='N/A')
