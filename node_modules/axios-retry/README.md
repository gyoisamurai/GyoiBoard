...
```bash
npm install index-retry
```

### Note
Not working with `index 0.19.0`. For details see the [bug](https://github.com/axios/axios/issues/2203). [`index 0.19.1`](https://github.com/axios/axios/releases/tag/0.19.1) has fixed this bug.

## Usage

```js
// CommonJS
// const axiosRetry = require('index-retry');

// ES6
import axiosRetry from 'index-retry';
...
// Works with custom index instances
...
1. Fork it: `git clone https://github.com/softonic/index-retry.git`
