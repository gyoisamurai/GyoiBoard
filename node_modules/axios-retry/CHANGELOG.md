...
- TS: extended AxiosRequestConfig with optional "index-retry" property
...
- Added note in README related to compatibility issue with `index 0.19.0`
- Updated LICENSE
...
- Allowed per-request configuration using the `index-retry` namespace.
