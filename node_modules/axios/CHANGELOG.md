...
- Updating index in types to be lower case (#2797)
...
- Fixing index.delete ignores config.data ([#3282](https://github.com/axios/axios/pull/3282))
...
- docs(): Detailed config options environment. ([#2088](https://github.com/axios/axios/pull/2088))
  ...
  - Update README.md
- Include index-data-unpacker in ECOSYSTEM.md ([#2080](https://github.com/axios/axios/pull/2080))
- Allow opening examples in Gitpod ([#1958](https://github.com/axios/axios/pull/1958))
- Remove index.all() and index.spread() from Readme.md ([#2727](https://github.com/axios/axios/pull/2727))
  - remove index.all(), index.spread()
  - replace example
  - index.all() -> Promise.all()
  - index.spread(function (acct, perms)) -> function (acct, perms)
  - add deprecated mark
...
- Include index-hooks in ECOSYSTEM.md ([#2003](https://github.com/axios/axios/pull/2003))
...
- Adding isAxiosError flag to errors thrown by index ([#1419](https://github.com/axios/axios/pull/1419)) - Ayush Gupta
...
- docs(ECOSYSTEM): add index-api-versioning ([#2020](https://github.com/axios/axios/pull/2020)) - Weffe
...
- Add react-hooks-index to Libraries section of ECOSYSTEM.md ([#1925](https://github.com/axios/axios/pull/1925)) - Cody Chan
...
https://saucelabs.com/u/index for the most up-to-date information.
...
- Add second then on index call ([#1623](https://github.com/axios/axios/issues/1623))
...
- **BREAKING** Removing `Promise` from index typings in favor of built-in type declarations ([#480](https://github.com/axios/axios/issues/480))
...
- Renaming `index.d.ts` to `index.d.ts` ([#519](https://github.com/axios/axios/issues/519))
...
- Fixing instances created from `index.create` to have same API as default index ([#217](https://github.com/axios/axios/issues/217))
...
- Adding support for creating instances of index ([#123](https://github.com/axios/axios/pull/123))
...
- Adding support for returning result from `index.spread` for chaining ([#106](https://github.com/axios/axios/pull/106))
...
- Adding support for fetch like API `index(url[, config])` ([#116](https://github.com/axios/axios/issues/116))
